...
ground2=new Ground(800,300,230,20)
...
box17=new Box(800,270,30,40)
 box18=new Box(785,270,30,40)
 box19=new Box(770,270,30,40)
 box20=new Box(755,270,30,40)
box21=new Box(815,270,30,40)
box22=new Box(830,270,30,40)
box23 = new Box(845,270,30,40) 
 box24 = new Box(792,230,30,40)
 box25 = new Box(800,230,30,40)
 box26 = new Box(812,230,30,40)
 box27 = new Box(806,200,30,40)
 box28 = new Box(818,200,30,40)
 box29 = new Box(810,160,30,40)
 box30 = new Box(780,230,30,40)
 box31 = new Box(824,230,30,40)
 box32 = new Box(792,200,30,40)
circle1=new Circle(100,200,37)
